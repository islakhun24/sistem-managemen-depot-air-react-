import {
  ...
  const Index = () => {
    ...
    const fetchData = useCallback(async () => {
      const response = await service.getPengeluaran(query);
      return response;
    }, [query]);
    ...
    const handleSearch = (event) => {
      setQuery('?nama_pengeluaran=' + event.target.value);
              ...
              {pengeluaran.map((val) => {
                return (
                  ...
                  <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                      <p className="text-gray-900 whitespace-no-wrap">{val.date}</p>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                      <p className="text-gray-900 whitespace-no-wrap">{val.nama_pengeluaran}</p>
                    </td>
                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                    ...
                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                     ...
                     <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                      <p className="text-gray-900 whitespace-no-wrap">{val.keterangan}</p>
                     </td>
