...
const AddPengeluaran = (props) => {
    ...
    useEffect(()=>{
        service.getPengeluaranById(id).then(res=>{
            const {data} = res.data
            setNamaPengeluaran(data.nama_pengeluaran);
    ...
    const handleSubmit = () => {
        ...
        service.updatePengeluaran(id, data).then(res=>{
            handleClose();
        ...
        <div>
            ...
            >
                ...
                <DialogContentText id="alert-dialog-description">
                    apakah anda yakin ingin edit pengeluaran ?
                </DialogContentText>
                </DialogContent>
                <DialogActions>
